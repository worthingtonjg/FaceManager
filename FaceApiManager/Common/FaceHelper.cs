namespace FaceApiManager.Common
{
    ...
    namespace FaceRoll.Common
    {
        public class FaceHelper
        {
            ...
            public async Task CreatePersonGroup(string personGroupId, string personGroupName = null)
            {
                if(personGroupName == null)
                {
                    personGroupName = personGroupId;
                }

                await _faceClient.PersonGroup.CreateAsync(personGroupId.ToLower(), personGroupName);
            }
            ...
            public async Task RemoveFace(string personGroupId, Guid personId, Guid persistedFaceId)
            {
